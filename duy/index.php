...
<style>
body,h1,h2,h3,h4,h5,h6 {font-family: "Kalibri", sans-serif}
...
<nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left" style="display:none;z-index:2;width:40%;min-width:300px" id="mySidebar">
  ...
  <a href="#food" onclick="w3_close()" class="w3-bar-item w3-button">Thức Ăn, Đồ Uống</a>
  <a href="doanchinh.php" onclick="w3_close()" class="w3-bar-item w3-button">Đồ Ăn Chính</a>
  <a href="nuoc.php" onclick="w3_close()" class="w3-bar-item w3-button">Nước</a>
